...
module.exports = {
    ...
    getSmartSwitchSelectMenu: function (guildId, serverId, entityId) {
        ...
        const autoOnAnyOffline = Client.client.intlGet(guildId, 'autoOnAnyOfflineCap');
        const autoOffAnyOffline = Client.client.intlGet(guildId, 'autoOffAnyOfflineCap');
        ...
        else if (entity.autoDayNightOnOff === 9) autoDayNightOnOffString += autoOnAnyOffline;
        else if (entity.autoDayNightOnOff === 10) autoDayNightOnOffString += autoOffAnyOffline;
        ...
        return new Discord.ActionRowBuilder().addComponents(
            module.exports.getSelectMenu({
                ...
                options: [
                    ...
                    {
                        label: autoOnAnyOffline,
                        description: Client.client.intlGet(guildId, 'smartSwitchAutoOnAnyOffline'),
                        value: '9'
                    },
                    {
                        label: autoOffAnyOffline,
                        description: Client.client.intlGet(guildId, 'smartSwitchAutoOffAnyOffline'),
                        value: '10'
                    }]
            }));
    },
