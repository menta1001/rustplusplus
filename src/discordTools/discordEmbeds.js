...
module.exports = {
    ...
    getStorageMonitorEmbed: function (guildId, serverId, entityId) {
        ...
        const hasCapacity = typeof storageMonitor.capacity === 'number';
        const hasItems = Array.isArray(storageMonitor.items);

        if (!hasCapacity || !hasItems) {
            return module.exports.getEmbed({
                title: `${entity.name}${grid}`,
                color: Constants.COLOR_DEFAULT,
                description: `${description}\n${Client.client.intlGet(guildId, 'statusNotElectronicallyConnected')}`,
        ...
        const expiry = storageMonitor.expiry || 0;
    ...
    getUpdateEventInformationEmbed: function (rustplus) {
        ...
        const bradleyFieldName = Client.client.intlGet(guildId, 'bradleyApc');
        ...
        const bradleyMessage = rustplus.getCommandBradly(true);
        ...
        return module.exports.getEmbed({
            ...
            fields: [
                ...
                { name: bradleyFieldName, value: `\`${bradleyMessage}\``, inline: true },
