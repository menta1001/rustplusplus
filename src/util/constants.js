...
module.exports = {
    ...
    DEFAULT_BRADLEY_RESPAWN_TIME_MS: 60 * 60 * 1000, /* 60 min */
    DEFAULT_BRADLEY_CRATE_UNLOCK_TIME_MS: 3 * 60 * 1000, /* 3 min */
    DEFAULT_BRADLEY_SCRAPABLE_TIME_MS: 5 * 60 * 1000, /* 5 min */

    /* Other constants */
    PATROL_HELI_DOWNED_RADIUS: 400,
    BRADLEY_DETECTION_RADIUS: 180,
    ...
    COLOR_BRADLEY_APC_DESTROYED: '#FF7F50',
    COLOR_BRADLEY_APC_RESPAWNED: '#4682B4',
    COLOR_BRADLEY_APC_CRATES_LOOTABLE: '#DAA520',
    COLOR_BRADLEY_APC_SCRAPABLE: '#708090',
